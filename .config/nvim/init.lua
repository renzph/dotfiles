...
-- Create a command to toggle virtual text
vim.api.nvim_create_user_command("ToggleDiagnosticsVT", ToggleDiagnosticsVirtualText, {})
vim.keymap.set("n", "<leader>td", ToggleDiagnosticsVirtualText, { desc = "Toggle Virtual Text Diagnostics" })
-- Enable break indent
